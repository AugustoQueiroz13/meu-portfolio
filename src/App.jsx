...
export default function App() {
  ...
  const projetos = [
    {
      titulo: lang === 'pt' ? "Pesquisador Engenheiro de Machine Learning - Firjan SENAI" : "Machine Learning Engineer - Firjan SENAI",
...
const formacaoList = [
  ...
  },
  {
    ...
    tipo: lang === 'pt' ? "Graduação, Tecnólogo | UNICIVE - Centro Universitário Cidade Verde" : "Degree, Technologist | UNICIVE - Centro Universitário Cidade Verde",
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 md:gap-4 pt-8">
            {[
              ...
              { href: "https://lattes.cnpq.br/4880095674938694/", icon: <FaAddressCard size={22} />, label: "Lattes" },
