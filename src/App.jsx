...
import {
  ...
  FaDocker, FaSync, FaBars, FaTimes, FaJava
} from 'react-icons/fa';
...
export default function App() {
  ...
  const t = {
    pt: {
      ...
      contatoDesc: "Seja para discutir uma oportunidade, trocar ideias sobre tecnologia ou conversar sobre inovações educacionais, minha caixa de entrada está sempre aberta.",
      btnContato: "Diga Olá",
    ...
    en: {
      ...
      contatoDesc: "Whether it's to discuss an opportunity, exchange ideas about technology, or talk about educational innovations, my inbox is always open.",
  ...
  const projetos = [
    {
      ...
      descricao: lang === 'pt' ? "Página desenvolvida para orientar os projetos finais do programa Bolsa Futuro Digital, destacando os trabalhos apresentados pelos alunos em aplicações de tecnologias emergentes no ensino." : "Page developed to guide the final projects of the Digital Future Grant program, highlighting the students' work in applying emerging technologies in education.",
    ...
    },
    {
      ...
      descricao: lang === 'pt' ? "Página responsiva desenvolvida para a instituição. Projetada com foco em acessibilidade, identidade visual e gestão eficiente de conteúdo." : "Responsive web platform developed for the institution. Designed with a focus on accessibility, visual identity, and efficient content management.",
    ...
    },
    {
      ...
      descricao: lang === 'pt' ? "Plataforma E-learning dedicada ao ensino prático de robótica educacional, com módulos interativos para lógica de programação e cultura maker." : "E-learning platform dedicated to the practical teaching of educational robotics, featuring interactive modules for programming logic and maker culture.",
    ...
    },
    {
      ...
      tipo: "Sistema Web",
      descricao: lang === 'pt' ? "Plataforma completa para gestão e operações financeiras para pessoas físicas e pequenos empreendedores. Arquitetada com foco em estabilidade e usabilidade intuitiva para o usuário final." : "Complete platform for financial management and operations aimed at individuals and small entrepreneurs. Architected with a focus on stability and intuitive usability.",
    ...
    },
    {
      ...
      descricao: lang === 'pt' ? "Obra didática sobre os fundamentos da programação em Python com IA. Um guia estruturado passo a passo para o desenvolvimento do raciocínio lógico." : "Educational book on the fundamentals of Python programming with AI. A structured step-by-step guide for developing logical reasoning.",
    ...
    },
    {
      ...
      descricao: lang === 'pt' ? "Projeto financiado pela FAPERJ em parceria com a Faculdade Redentor, de um medidor digital de energia com análise econômica. Captura e transmite dados de consumo em tempo real." : "FAPERJ-funded project in partnership with Redentor College for a digital energy meter with economic analysis. Captures and transmits consumption data in real time.",
  ...
  const publicacoesList = [
    {
      ...
      local: lang === 'pt' ? "ERMAC Regional 8 (INPE) - Encontro Regional de Matemática Aplicada e Computacional" : "ERMAC Regional 8 (INPE) - Regional Meeting of Applied and Computational Mathematics",
      badges: [lang === 'pt' ? "Apresentação em Pôster" : "Poster Presentation", "2026"]
    },
    {
